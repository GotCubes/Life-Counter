...
public class GameView4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_view4);

        String lifeTotal = getIntent().getStringExtra("LIFE_TOTAL").isEmpty() ? "40" : getIntent().getStringExtra("LIFE_TOTAL");
        ...
        int p4Color = Integer.parseInt(getIntent().getStringExtra("P4_COLOR"));
        TextView p4Border = findViewById(R.id.p4Border);

        switch(p4Color) {
            case 0:
                p4Border.setBackgroundResource(R.drawable.border_red);
                break;

            case 1:
                p4Border.setBackgroundResource(R.drawable.border_blue);
                break;

            case 2:
                p4Border.setBackgroundResource(R.drawable.border_purple);
                break;

            case 3:
                p4Border.setBackgroundResource(R.drawable.border_green);
                break;
        }
        ...
        Button p4Add = findViewById(R.id.p4Add);
        p4Add.setOnTouchListener(new View.OnTouchListener() {
            Handler handle = new Handler();
            Runnable runner = new Runnable() {
                @Override
                public void run() {
                    TextView p4 = findViewById(R.id.p4);
                    int val = Integer.parseInt(p4.getText().toString());
                    int result = val + holdValue;
                    p4.setText(result + "");
                    handle.postDelayed(runner, 500);
                }
        ...
        Button p4Sub = findViewById(R.id.p4Sub);
        p4Sub.setOnTouchListener(new View.OnTouchListener() {
            Handler handle = new Handler();
            Runnable runner = new Runnable() {
                @Override
                public void run() {
